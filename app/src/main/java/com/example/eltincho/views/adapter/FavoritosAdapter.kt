...
class FavoritosAdapter(private val context: android.content.Context, var clickListenerDeseosAdapter: OnDeseosItemClickLitener):RecyclerView.Adapter<FavoritosAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        fun binWew(favorito: favoritos, action:OnDeseosItemClickLitener){
            ...
            val btneliminar=itemView.findViewById<ImageButton>(R.id.eliminarItem)
